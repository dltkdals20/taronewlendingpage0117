    ...
    return (
        <>
            <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-[#fdf2f8] to-[#f3e8ff] p-6 md:p-10 rounded-3xl border-2 border-[#9810fa]/20 shadow-xl max-w-lg mx-auto relative overflow-hidden"
            >
                {/* Badge */}
                <div className="absolute top-0 right-0 bg-[#ff4500] text-white font-bold px-6 py-2 rounded-bl-2xl shadow-md">
                    60% OFF
                </div>

                <h3 className="text-xl md:text-2xl font-bold text-slate-800 mb-4 pr-28 break-keep">
                    신년 타로 운세 대박 패키지
                </h3>
                ...
                <ul className="text-left space-y-4 mb-10 max-w-xs mx-auto text-slate-600">
