        ...
        <div className="w-full bg-white py-24 px-4 flex flex-col items-center">
            <div className="max-w-4xl w-full text-center">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-gradient-to-br from-[#fdf2f8] to-[#f3e8ff] p-10 rounded-3xl border-2 border-[#9810fa]/20 shadow-xl max-w-lg mx-auto relative overflow-hidden"
                >
                    {/* Badge */}
                    ...
                    <ul className="text-left space-y-4 mb-10 max-w-xs mx-auto text-slate-600">
                        ...
                        <li className="flex items-center gap-3">
                            <span className="text-[#9810fa]">✓</span> 24시간 이내 발송
                        </li>
                    </ul>
